...
<%@ page import="com.nextu.entities.Categorie" %>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 pr-0 mb-3">
            <div class="card-collapsible card">
              <div class="card-header">
                Modifier une cat�gorie <i class="fa fa-caret-down caret"></i>
              </div>
              <div class="card-body">
                <form method="post" action="modifierCategorie">
                
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Intitul� de la cat�gorie" name="nom" value="${categorie.nom}">
                  </div>
